#!/usr/bin/env python
"""
Package metadata for platform_plugin_ontask.
"""
import os
import re
import sys
...
setup(
    name='platform-plugin-ontask',
    version=VERSION,
    description="""Open edX Django plugin for OnTask Learning.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='eduNEXT',
    author_email='technical@edunext.co',
    url='https://github.com/eduNEXT/platform-plugin-ontask',
    packages=find_packages(
        include=['platform_plugin_ontask', 'platform_plugin_ontask.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "platform_plugin_ontask = platform_plugin_ontask.apps:PlatformPluginOntaskConfig",
        ],
    },
)
