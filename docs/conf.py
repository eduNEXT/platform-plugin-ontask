...
"""
platform-plugin-ontask documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform-plugin-ontask',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/platform-plugin-ontask",
...
#
# html_title = 'platform-plugin-ontask v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Open edX Django plugin for OnTask Learning.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_ontask'),
                os.path.join(root_path, 'platform_plugin_ontask/migrations')])
